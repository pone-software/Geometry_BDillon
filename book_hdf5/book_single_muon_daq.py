...
parser.add_option("-i", "--infile",
                  default="/home/users/bdillon/P-ONE/sim0002/daqfiles/SingleMuon_*.i3.gz",
                  dest="infile", help="input file (.i3 format)", type=str)
parser.add_option("--outfile", default="sim0002_daq_data_effectiveArea.hdf5", type=str,
