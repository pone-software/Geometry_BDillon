...
opts = {}
opts["out"] = '/home/users/bdillon/P-ONE/sim0002/linefit'
opts["data"] = '/home/users/bdillon/P-ONE/sim0002/daqfiles'
opts["job"] = '/home/users/bdillon/P-ONE/sim0002/src_sim'
opts["gcd"] = '/home/users/bdillon/P-ONE/sim0002/gcdfile'

processfilename = 'run_linefit'
submissionfilename = 'run_linefit.submit'

job_string = '''#!/bin/bash 

bash /home/users/bdillon/pone_offline/env-shell_Container.sh python {}/TrackReconstruction.py -i {} -o {} -r $1 -g {}
